	...
	<body>	
		<div id="page_home" class="page" data-role="page">
			...
			<div id="header" data-role="header" data-theme="a">
				<div id="header_logo">
				<a href="action-figures.php" data-ajax="false" data-prefetch
			...
			<div id="headerFill" class="dynamic_text">
				<h2	class="header_text">G.I. Joe</h2>
			</div>
			<!--End of Page Title-->
			...
			<?php
				...
				$result = mysqli_query($con,"SELECT * FROM `Items` WHERE Category in ('G.I. Joe')");
