	...
	<body>	
		<div id="page_home" class="page" data-role="page">
			...
			<div id="headerFill" class="dynamic_text">
				<h2	class="header_text">Action Figures</h2>
			</div>
			<!--End of Page Title-->
			<!--Menu Options-->
			<div id="nav" class="dynamic_size">
				...
				<div id="list">
					<ul class="dynamic" data-role="listview" data-inset="true" data-theme="a">
						<li><a href="action-figures-view.php" rel="external">All Action Figures</a></li>
						<li><a href="gi-joe-view.php" rel="external">G.I. Joe</a></li>
					</ul>
				</div>
			</div>
			<!--End of Menu Options-->
