	...
	<body>	
		<div id="page_home" class="page" data-role="page">
			...
			<div id="header" data-role="header" data-theme="a">
				<div id="header_logo">
				<a href="fiction.php" data-ajax="false" data-prefetch
			...
			<div id="headerFill" class="dynamic_text">
				<h2	class="header_text">All Fiction</h2>
			</div>
			<!--End of Page Title-->
			...
			<?php
				...
				$result = mysqli_query($con,"SELECT * FROM `Items` WHERE Category in ('Fiction', 'Comic Books')");
