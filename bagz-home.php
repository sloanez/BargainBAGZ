			...
			<div id="nav" class="dynamic_size">
				...
				<div id="list">
					<ul class="dynamic" data-role="listview" data-inset="true" data-theme="a">
						<li><a href="categories-select.html" rel="external">Categories and Search</a></li>
						<li><a href="featuredItems.php" rel="external">Featured Items</a></li>
						<li><a href="sell.html" rel="external">Sell An Item</a></li>
					</ul>
				</div>
			</div>
			<!--End of Menu Options-->
